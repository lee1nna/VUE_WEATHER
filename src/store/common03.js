  ...
  getters: {
    CHANGED_DATA(context) {
      ...
      if (context.state.changedData.lat == 37.566826 && context.state.changedData.lon == 126.9786567) {
        this.CITY_NAME = 'Seoul';
      }
      if (context.state.changedData.lat == 37.40864282648822 && context.state.changedData.lon == 126.65071862847725) {
        this.CITY_NAME = 'Incheon';
      }
      if (context.state.changedData.lat == 37.2911 && context.state.changedData.lon == 127.0089) {
        this.CITY_NAME = 'Suwon';
      }
      if (context.state.changedData.lat == 37.791688035246636 && context.state.changedData.lon == 128.82867301427635) {
        this.CITY_NAME = 'gangneung';
      }
      if (context.state.changedData.lat == 37.15818414766273 && context.state.changedData.lon == 128.928560966107) {
        this.CITY_NAME = 'Taebaek';
      }
      if (context.state.changedData.lat == 36.3519957815787 && context.state.changedData.lon == 127.39131469478555) {
        this.CITY_NAME = 'Daejeon';
      }
      if (context.state.changedData.lat == 35.90493196781132 && context.state.changedData.lon == 127.17357575637105) {
        this.CITY_NAME = 'Jeonju';
      }
      if (context.state.changedData.lat == 35.166611792579545 && context.state.changedData.lon == 126.84603104436039) {
        this.CITY_NAME = 'Gwangju';
      }
      if (context.state.changedData.lat == 35.823630139082525 && context.state.changedData.lon == 126.39766650967137) {
        this.CITY_NAME = 'Mokpo';
      }
      if (context.state.changedData.lat == 35.871148697228875 && context.state.changedData.lon == 128.61345034272617) {
        this.CITY_NAME = 'Daegu';
      }
      if (context.state.changedData.lat == 35.5372 && context.state.changedData.lon == 129.3167) {
        this.CITY_NAME = 'Ulsan';
      }
      if (context.state.changedData.lat == 35.185997613083536 && context.state.changedData.lon == 129.0662809358643) {
        this.CITY_NAME = 'Busan';
      }
      if (context.state.changedData.lat == 33.5097 && context.state.changedData.lon == 126.5219) {
        this.CITY_NAME = 'Jeju';
      }
