      ...
      axios
        ...
        .then((res) => {
          ...
          for (let i = 0; i < 24; i++) {
            ...
            // if (img == '01d') {
            //   context.commit('SET_DATA02', 'src/assets/26.png');
            //   // this.images[i] = 'src/assets/26.png';
            // }
            // if (img == '01n') {
            //   context.commit('SET_DATA02', 'src/assets/10.png');
            //   // this.images[i] = 'src/assets/10.png';
            // }
            // if (img == '02d') {
            //   context.commit('SET_DATA02', 'src/assets/27.png');
            //   // this.images[i] = 'src/assets/27.png';
            // }
            // if (img == '02n') {
            //   context.commit('SET_DATA02', 'src/assets/31.png');
            //   // this.images[i] = 'src/assets/31.png';
            // }
            // if (img == '03d') {
            //   context.commit('SET_DATA02', 'src/assets/33.png');
            //   // this.images[i] = 'src/assets/33.png';
            // }
            // if (img == '03n') {
            //   context.commit('SET_DATA02', 'src/assets/32.png');
            //   // this.images[i] = 'src/assets/32.png';
            // }
            // if (img == '04d') {
            //   context.commit('SET_DATA02', 'src/assets/35.png');
            ...
            // }
            // if (img == '09d') {
            //   context.commit('SET_DATA02', 'src/assets/5.png');
            ...
            // }
            // if (img == '10d') {
            //   context.commit('SET_DATA02', 'src/assets/8.png');
            //   // this.images[i] = 'src/assets/8.png';
            // }
            // if (img == '10n') {
            //   context.commit('SET_DATA02', 'src/assets/1.png');
            //   // this.images[i] = 'src/assets/1.png';
            // }
            // if (img == '11d') {
            //   context.commit('SET_DATA02', 'src/assets/17.png');
            ...
            // }
            // if (img == '13d') {
            //   context.commit('SET_DATA02', 'src/assets/18.png');
            ...
            // }
            // if (img == '50d') {
            //   context.commit('SET_DATA02', 'src/assets/6.png');
            //   // this.images[i] = 'src/assets/6.png';
            // }
            // if (img == '50n') {
            //   context.commit('SET_DATA02', 'src/assets/9.png');
